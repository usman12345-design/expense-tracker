...
return function (App $app) {
    ...
    $app->group('', function(RouteCollectorProxy $group) {
        ...
        $group->post('/verify', [VerifyController::class, 'resend'])->setName('resendVerification')
    ...
    $app->group('', function (RouteCollectorProxy $guest) {
        ...
        $guest->post('/register', [AuthController::class, 'register'])->setName('register')
            ->add(RateLimitMiddleware::class);
        $guest->post('/login/two-factor', [AuthController::class, 'twoFactorLogin'])->setName('twoFactorLogin')
            ->add(RateLimitMiddleware::class);
        ...
        $guest->get('/reset-password/{token}', [PasswordResetController::class, 'showResetPasswordForm'])
            ...
            ->add(ValidateSignatureMiddleware::class);
        $guest->post('/forgot-password', [PasswordResetController::class, 'handleForgotPasswordRequest'])->setName('handleForgetPassword')
            ->add(RateLimitMiddleware::class);
